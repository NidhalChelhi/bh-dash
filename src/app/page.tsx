    ...
    <main className="flex min-h-screen w-full flex-row  ">
      <div className="hidden sm:flex w-full bg-white items-center justify-center ">
        <img
          src="/main-logo.svg"
          alt="logo"
          className="h-72 w-full px-4 md:px-8 lg:px-24 gap-8 "
        />
      </div>
      <div className="flex w-full bg-primary flex-col items-center justify-center px-4 md:px-8 lg:px-24 gap-8 text-center">
        ...
        <div className="w-full max-w-[480px] flex flex-col gap-4">
          ...
          <Link
            href="/batteurs"
            className="flex items-center justify-center w-full px-8 py-4 bg-secondary rounded-xl cursor-pointer select-none hover:bg-opacity-95"
          >
